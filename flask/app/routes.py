from flask import Flask, session, render_template, request, jsonify, make_response, Blueprint, redirect, url_for, flash
...
#        session['room'] = 1
#        print("성공")
#        return render_template('allchat.html', room=1, name=current_user.get_user_id())
#    else:
